...
function PlacaDetailsPage() {
  ...
  const onAluguelSubmit = (data) => {
    const dataToSend = { placaId, ...data }; // ✅ Padronizado
         ...
         <form id="aluguel-form" className="modal-form" onSubmit={handleAluguelFormSubmit(onAluguelSubmit)} noValidate>
             <div className="modal-form__grid">
                 <div className="modal-form__input-group modal-form__input-group--full">
                     ...
                     <select id="clienteId"
                             className={`modal-form__input ${aluguelModalErrors.clienteId ? 'input-error' : ''}`}
                             {...registerAluguel('clienteId', { required: 'Cliente é obrigatório.' })}
                     ...
                     {aluguelModalErrors.clienteId && <div className="modal-form__error-message">{aluguelModalErrors.clienteId.message}</div>}
                 </div>
